...
public class LoginStepDefinitions {
    ...
    //Then user verifies that "Invalid user name or password." message id displayed
    @Then("user verifies that {string} message id displayed")
    public void user_verifies_that_message_id_displayed(String expected) {
        // Write code here that turns the phrase above into concrete actions
